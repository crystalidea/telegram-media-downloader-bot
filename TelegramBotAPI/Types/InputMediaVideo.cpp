...
QJsonObject Telegram::InputMediaVideo::toObject() const {
    ...
    if (std::holds_alternative<QFile*>(media))
    {
        ...
        input_media_video_json_object.insert("media", QString("attach://%1").arg(tg_media_name));
    }
    else if (std::holds_alternative<QString>(media))
        input_media_video_json_object.insert("media", std::get<QString>(media));
    ...
    input_media_video_json_object.insert("type", "video");
